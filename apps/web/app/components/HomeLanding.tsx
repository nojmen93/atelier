...
export default function HomeLanding({ onOpenQuote }: Props) {
  ...
  const colorName = colors.find((c) => c.id === activeColor)?.label ?? ''
  ...
  return (
    <div className="landing">
      ...
      <div className="landing-left">
        <div className="landing-eyebrow">Premium Custom Apparel</div>
      ...
      <div className="landing-right">
        ...
        <div className="product-showcase">
          <Image
            key={`${current.id}-${activeColor}`}
            src={current.images[activeColor]}
            alt={`${current.name} in ${colorName}`}
            fill
        ...
        <div className="product-info-bar">
          ...
          <div className="product-color-row">
            ...
            <span className="color-swatch-label">{colorName}</span>
          </div>

          <button
            className="landing-quote-btn"
            onClick={() => onOpenQuote(`${current.name} (${colorName})`)}
          >
            Get a Quote
        ...
        {/* Techniques strip */}
        <div className="techniques-strip">
          {techniques.map((t) => (
